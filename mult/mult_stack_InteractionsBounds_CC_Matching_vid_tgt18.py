...
7. Collect vertex_id from Stack
8. Make an array of part_pdg corresponding to vertex_id from Stack
9. Count the elements in part_pdg array and plot histogram of the multiplicity
"""
...
plt.xlabel('CC Multiplicity (Matching vertex_id within FV and Z = 18)')
plt.ylabel('Number of Events')
plt.title('Multiplicity Distribution (Minirun4_RHC)')
plt.xticks(range(1, 21))
plt.xlim(0.5, 20.5)
plt.legend(loc='upper right')
plt.savefig("mult_stack_InteractionsBounds_CC_Matching_vid_tgt18.png", dpi=300)
plt.show()
