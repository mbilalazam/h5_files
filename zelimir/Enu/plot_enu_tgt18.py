...
This script visualizes the energy distribution of neutrino events across different interaction, for target 18, types using a stacked histogram. Data is sourced from a series of HDF5 files, and the final output is saved as "enu_tgt18.png".
"""
    ...
    for idx, filename in enumerate(filenames, 1):
        ...
        with h5py.File(filename, 'r') as f:
            ...
            for interaction_type in interaction_types:
                mask = data[interaction_type][()] & target_mask  # Combine masks
