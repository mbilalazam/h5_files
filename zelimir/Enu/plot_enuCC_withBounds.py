...
Data is sourced from a series of HDF5 files, and the final output is saved as "enuCC_withBounds.png".
"""
...
def create_stacked_histogram(filenames, dataset_name):
    ...
    for idx, filename in enumerate(filenames, 1):
        ...
        with h5py.File(filename, 'r') as f:
            ...
            for interaction_type in interaction_types:
                mask = data[interaction_type][()] & isCC_mask & bounds_mask
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("enuCC_withBounds.png")
    plt.show()
