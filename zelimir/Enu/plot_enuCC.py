...
This script visualizes the energy distribution of charged current (CC) neutrino events across different interaction types using a stacked histogram. Data is sourced from a series of HDF5 files, and the final output is saved as "enuCC.png".
"""
import h5py
...
def create_stacked_histogram(filenames, dataset_name):
    ...
    plt.hist(enu_values_for_hist, bins=50, range=(1, 10), stacked=True, label=labels, color=color_values, edgecolor='black')
